    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        <itemtemplate>
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <p><%: articuloSeleccionado.Categoria != null ? articuloSeleccionado.Categoria.Descripcion : ""  %></p>
                        <h5 class="card-title"><%: articuloSeleccionado.Nombre %></h5>
                        <p><%: articuloSeleccionado.Marca != null ? articuloSeleccionado.Marca.Descripcion : "" %></p>
                        ...
                        <div id="carouselExample" class="carousel slide">
                            ...
                            <button class="carousel-control-prev" type="button" data-bs-target="#carouselExample" data-bs-slide="prev">
                                <span class="carousel-control-prev-icon" style="background-color: steelblue" aria-hidden="true"></span>
                                <span class="visually-hidden">Previous</span>
                            </button>
                            <button class="carousel-control-next" type="button" data-bs-target="#carouselExample" data-bs-slide="next">
                                <span class="carousel-control-next-icon" style="background-color: steelblue" aria-hidden="true"></span>
